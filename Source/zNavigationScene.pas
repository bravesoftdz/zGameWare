...
type
  ...
  public
    ...
    procedure LoadFromFile(FileName: umlString);
    procedure SaveToFile(FileName: umlString);
  end;
...
procedure TNavigationScene.LoadFromFile(FileName: umlString);
var
  s: TMemoryStream64;
begin
  s := TMemoryStream64.Create;
...
procedure TNavigationScene.SaveToFile(FileName: umlString);
var
  s: TMemoryStream64;
begin
  s := TMemoryStream64.Create;
